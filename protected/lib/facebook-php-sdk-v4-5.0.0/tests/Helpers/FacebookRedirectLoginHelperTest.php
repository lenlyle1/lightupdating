...
class FacebookRedirectLoginHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $scope = ['foo', 'bar'];
        $loginUrl = $this->redirectLoginHelper->getLoginUrl($this->REDIRECT_URL, $scope);
    ...
    {
        $logoutUrl = $this->redirectLoginHelper->getLogoutUrl('foo_token', $this->REDIRECT_URL);
    ...
    public function testAnAccessTokenCanBeObtainedFromRedirect()
    {
        ...
        $accessToken = $this->redirectLoginHelper->getAccessToken($this->REDIRECT_URL);

        $this->assertEquals('foo_token_from_code|foo_code|' . $this->REDIRECT_URL, (string)$accessToken);
    }
    ...
    public function testACustomCsprsgCanBeInjected()
    {
        ...
        $loginUrl = $helper->getLoginUrl($this->REDIRECT_URL);

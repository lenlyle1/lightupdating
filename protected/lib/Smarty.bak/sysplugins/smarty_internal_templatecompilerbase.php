...
abstract class Smarty_Internal_TemplateCompilerBase
{
    ...
    public function callTagCompiler($tag, $args, $param1 = null, $param2 = null, $param3 = null)
    {
        ...
        if (isset($this->$_tag_objects[$tag])) {
            // compile this tag
            return $this->$_tag_objects[$tag]->compile($args, $this, $param1, $param2, $param3);
        }
    ...
    public function getPluginFromDefaultHandler($tag, $plugin_type)
    {
        ...
        if ($result) {
            ...
            if (!is_string($callback) && !(is_array($callback) && is_string($callback[0]) && is_string($callback[1]))) {
                $this->trigger_template_error("Default plugin handler: Returned callback for \"{$tag}\" must be a function name or array of class and function name");
            }

...
class Smarty_Internal_Templateparser#line 80 "smarty_internal_templateparser.php"
{
    ...
    function yy_r7()
    {
        ...
        if ($this->php_handling == Smarty::PHP_PASSTHRU) {
            ...
            if (!($this->smarty instanceof SmartyBC)) {
                $this->compiler->trigger_template_error($this->Err3);
            }
    ...
    function yy_r114()
    {
        if (!$this->security || isset($this->smarty->registered_classes[$this->yystack[$this->yyidx + - 2]->minor]) || $this->smarty->security_policy->isTrustedStaticClass($this->yystack[$this->yyidx + - 2]->minor, $this->compiler)) {
            ...
            $this->compiler->trigger_template_error("class '" . $this->yystack[$this->yyidx + - 2]->minor . "' is undefined or not allowed by security setting");
        }
    }
    ...
    {
        $this->$prefix_number ++;
        $this->compiler->prefix_code[] = '<?php ob_start();?>' . $this->yystack[$this->yyidx + - 1]->minor . '<?php $_tmp' . $this->$prefix_number . '=ob_get_clean();?>';
    ...
    function yy_r144()
    {
        if ($this->security && substr($this->yystack[$this->yyidx + - 1]->minor, 0, 1) == '_') {
            $this->compiler->trigger_template_error($this->Err1);
        }
        $this->_retvalue = '->' . $this->yystack[$this->yyidx + - 1]->minor . $this->yystack[$this->yyidx + 0]->minor;
    }
    ...
    {
        if ($this->security) {
            $this->compiler->trigger_template_error($this->Err2);
        }

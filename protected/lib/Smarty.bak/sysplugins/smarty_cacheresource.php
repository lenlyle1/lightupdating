...
abstract class Smarty_CacheResource
{
     ...
     */
    public function load(Smarty $smarty, $type = null)
    {
        if (!isset($type)) {
        ...
        if (isset($this->$sysplugins[$type])) {
            if (!isset($this->$resources[$type])) {
                ...
                $this->$resources[$type] = new $cache_resource_class();
            }

            return $smarty->_cacheresource_handlers[$type] = $this->$resources[$type];
        }
        // try plugins dir

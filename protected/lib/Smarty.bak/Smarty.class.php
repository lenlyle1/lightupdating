...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     */
    public $_previous_error_handler = null;
    /**
     * contains directories outside of SMARTY_DIR that are to be muted by muteExpectedErrors()
     */
    public $_muted_directories = array();
    /**
     * Flag denoting if Multibyte String functions are available
     */
    public $_MBSTRING = SMARTY_MBSTRING;
    /**
     * The character set to adhere to (e.g. "UTF-8")
     */
    public $_CHARSET = SMARTY_RESOURCE_CHAR_SET;
    /**
     * The date format to be used internally
     * (accepts date() and strftime())
     */
    public $_DATE_FORMAT = SMARTY_RESOURCE_DATE_FORMAT;
    /**
     * Flag denoting if PCRE should run in UTF-8 mode
     */
    public $_UTF8_MODIFIER = 'u';

    /**
     * Flag denoting if operating system is windows
     */
    public $_IS_WINDOWS = false;
     ...
     * @var integer
     */
    public $php_handling = $this->PHP_PASSTHRU;
    /**
     ...
     * @return void
     */
    public function muteExpectedErrors()
    {
        /*
     ...
     * @return void
     */
    public function unmuteExpectedErrors()
    {
...
class SmartyException extends Exception
{
    ...
    {
        return ' --> Smarty: ' . ($this->$escape ? htmlentities($this->message) : $this->message) . ' <-- ';
    }
}

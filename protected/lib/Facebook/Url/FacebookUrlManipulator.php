...
class FacebookUrlManipulator
{
     ...
     * @return string
     */
    public function appendParamsToUrl($url, array $newParams = [])
    {
        if (!$newParams) {
            return $url;
        }
     ...
     * @return array
     */
    public function getParamsAsArray($url)
    {
     ...
     */
    public function mergeUrlParams($urlToStealFrom, $urlToAddTo)
    {
     ...
     */
    public function baseGraphUrlEndpoint($urlToTrim)
    {

...
class FacebookCurlHttpClient implements FacebookHttpClientInterface
{
    ...
    private function getHeaderSize()
    {
        ...
        if ($this->needsCurlProxyFix()) {
            ...
            } elseif (stripos($this->rawResponse, $this->CONNECTION_ESTABLISHED) !== false) {
                $headerSize += mb_strlen($this->CONNECTION_ESTABLISHED);
            }
        }
    ...
    private function needsCurlProxyFix()
    {
        ...
        return $version < $this->CURL_PROXY_QUIRK_VER;
    }
}

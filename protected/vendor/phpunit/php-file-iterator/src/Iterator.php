...
class File_Iterator extends FilterIterator
{
    ...
    {
        return $this->acceptSubString($filename, $this->prefixes, $this->PREFIX);
    }
    ...
    {
        return $this->acceptSubString($filename, $this->suffixes, $this->SUFFIX);
    }
    ...
    protected function acceptSubString($filename, array $subStrings, $type)
    {
        ...
        foreach ($subStrings as $string) {
            if (($type == $this->PREFIX && strpos($filename, $string) === 0) ||
                ($type == $this->SUFFIX &&

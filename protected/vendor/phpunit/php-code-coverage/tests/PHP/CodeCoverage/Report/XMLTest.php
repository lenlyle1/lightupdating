...
class PHP_CodeCoverage_Report_XMLTest extends PHP_CodeCoverage_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        $this->$TEST_REPORT_PATH_SOURCE = TEST_FILES_PATH . 'Report' . DIRECTORY_SEPARATOR . 'XML';
    }
    ...
    protected function tearDown()
    {
        ...
        $tmpFilesIterator = new FilesystemIterator($this->$TEST_TMP_PATH);
    ...
    public function testForBankAccountTest()
    {
        ...
        $xml->process($this->getCoverageForBankAccount(), $this->$TEST_TMP_PATH);
    ...
    public function testForFileWithIgnoredLines()
    {
        ...
        $xml = new PHP_CodeCoverage_Report_XML;
        $xml->process($this->getCoverageForFileWithIgnoredLines(), $this->$TEST_TMP_PATH);
    ...
    public function testForClassWithAnonymousFunction()
    {
        ...
        $xml = new PHP_CodeCoverage_Report_XML;
        $xml->process($this->getCoverageForClassWithAnonymousFunction(), $this->$TEST_TMP_PATH);

...
EOF;
    ...
    {
        $this->setPhpContent($this->EXPECT_CONTENT);
    ...
    public function testShouldRunSkipifSectionWhenExists()
    {
        ...
        $phptContent = $this->EXPECT_CONTENT . PHP_EOL;
...
EOF
    ...
    {
        $this->setPhpContent($this->EXPECTF_CONTENT);
    ...
    {
        $this->setPhpContent($this->EXPECTREGEX_CONTENT);

...
abstract class PHPUnit_Framework_Assert
{
    ...
    public static function assertJsonStringNotEqualsJsonFile($expectedFile, $actualJson, $message = '')
    {
        ...
        $this->assertThat($actualJson, new PHPUnit_Framework_Constraint_Not($constraint), $message);
    }
    ...
    public static function assertJsonFileNotEqualsJsonFile($expectedFile, $actualFile, $message = '')
    {
        ...
        $this->assertThat($expectedJson, new PHPUnit_Framework_Constraint_Not($constraintActual), $message);
        $this->assertThat($actualJson, new PHPUnit_Framework_Constraint_Not($constraintExpected), $message);
    }

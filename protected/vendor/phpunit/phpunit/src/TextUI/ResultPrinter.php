...
class PHPUnit_TextUI_ResultPrinter extends PHPUnit_Util_Printer implements PHPUnit_Framework_TestListener
{
    ...
    const COLOR_DEFAULT = $this->COLOR_NEVER;
     ...
     */
    public function __construct($out = null, $verbose = false, $colors = $this->COLOR_DEFAULT, $debug = false, $numberOfColumns = 80, $reverse = false)
    {
        ...
        $availableColors = [$this->COLOR_NEVER, $this->COLOR_AUTO, $this->COLOR_ALWAYS];
        ...
        if ($colors === $this->COLOR_AUTO && $console->hasColorSupport()) {
            $this->colors = true;
        } else {
            $this->colors = ($this->COLOR_ALWAYS === $colors);
        }
    }

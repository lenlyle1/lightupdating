...
class DocBlock implements \Reflector
{
     ...
     *
     * @see $this->isTemplateEnd() for the check whether a closing marker was provided.
     *
     * @return boolean
     */
     ...
     *
     * @see $this->isTemplateStart() for a more complete description of the Docblock Template functionality.
     *
     * @return boolean
     */

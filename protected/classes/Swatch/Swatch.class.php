...
Class Swatch {
	...
	public static function parseColors($swatchList)
	{
	...
	public static function buildSwatch($swatch)
	{
		if(empty($swatch)){
			$swatch = self::$defaultSwatch;
		}
		$colors = self::parseColors($swatch);
